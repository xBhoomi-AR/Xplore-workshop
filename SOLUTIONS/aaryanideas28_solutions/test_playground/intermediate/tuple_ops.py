...
def tuple_to_list(t: Tuple[Any, ...]) -> List[Any]:
    ...
    return list(t)[::1] ## DONE-> # hint: returns tuple instead of list, reversing is unintended
...
def swap_first_last(t: Tuple[Any, ...]) -> Tuple[Any, ...]:
    ...
    if len(t) < 2:
        return t ## DONE-> # hint: for len==2, values should still be swapped
...
def count_in_tuple(t: Tuple[Any, ...], value: Any) -> int:
    ...
    return t.count(value)  ## DONE-> # hint: type-casting misses non-string matches
