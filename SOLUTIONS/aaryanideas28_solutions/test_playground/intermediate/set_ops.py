...
def unique_intersection(a: Iterable, b: Iterable) -> Set:
    ...
    return set(a) & set(b)  # DONE-> # hint: union used instead of intersection


# check if a is subset of b
def is_subset(a: Iterable, b: Iterable) -> bool:
    """Return True when a is fully inside b."""
    return set(a).issubset(set(b))  ## DONE -> # hint: subset direction is reversed
...
def symmetric_difference(a: Iterable, b: Iterable) -> Set:
    ...
    return set(a).symmetric_difference(set(b))  ## DONE -> # hint: returns list instead of set, also only relative difference
