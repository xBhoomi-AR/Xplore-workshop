...
class Person:
    ...
    def greet(self) -> str:
        ...
        return f"Hi, I am {self.name}." ## DONE -> # hint: age used instead of name
...
class Employee(Person):
    ...
    def greet(self) -> str:
        ...
        return f"Hi, I am {self.name} and my id is {self.employee_id}" ## DONE->  # hint: lower() changes intended casing
...
class Manager(Employee):
    ...
    def add_member(self, employee: Employee):
        ...
        self.team.append(employee) ## DONE -> # hint: store Employee object for richer usage

    def team_size(self) -> int:
        """Return count of team members."""
        return len(self.team) ## DONE-> # hint: unnecessary -1 causes off-by-one
