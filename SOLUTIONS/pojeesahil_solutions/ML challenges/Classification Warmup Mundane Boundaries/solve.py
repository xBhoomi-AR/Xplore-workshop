...
def train():
    ...
    #model=LogisticRegression(max_iter=1000) 95% accuracy
    #model = RandomForestClassifier(n_estimators=100, random_state=42) 96% accuracy
    model = make_pipeline(StandardScaler(), SVC(kernel='rbf', random_state=42,probability=True)) #98% accuracy
