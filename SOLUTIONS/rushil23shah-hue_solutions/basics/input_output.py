...
print(str(nums)[1:-1]) # print it as a string joined by commas : 1,2,3,4
...
print(x,y,z, sep="\n") # change only this line, sep is separator, default is space, change it to new line character
