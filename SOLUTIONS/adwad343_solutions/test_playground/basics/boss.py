...
while choice =='y' or choice=='Y' : # make 'Y' valid too
    try:
        ...
        if len(numbers)-1  !=  len(operators): # this seems odd... u might say it's ... off by one
            print("There is a an error in lengths of both the lists") # replace wiht better message :)
            continue
        
        flag = True # huh this seems inverted                 2 2
        ...
        print(f"Invalid Input") # print exception
    finally:
