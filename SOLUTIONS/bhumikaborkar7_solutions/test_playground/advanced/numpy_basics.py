...
def matrix_multiplication(A, B):
    ...
    if m1.shape[1] != m2.shape[0]:
        raise ValueError("invalid matrices, multiplication cant be performed")
    return np.matmul(m1, m2 ) # hint: this is elementwise multiply, use @ or np.matmul # (doing matrix multiplication here)
